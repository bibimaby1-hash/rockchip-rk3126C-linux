...
KBUILD_CFLAGS := -Wno-error -Wno-int-to-pointer-cast -Wno-dangling-pointer -Wno-pointer-to-int-cast -Wno-array-compare -Wno-int-to-pointer-cast -Wno-dangling-pointer -Wno-pointer-to-int-cast -Wno-dangling-pointer  -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
